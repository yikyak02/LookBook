...
import 'hatsdisplay_model.dart';
export 'hatsdisplay_model.dart';

class HatsdisplayWidget extends StatefulWidget {
  const HatsdisplayWidget({super.key});

  @override
  State<HatsdisplayWidget> createState() => _HatsdisplayWidgetState();
}

class _HatsdisplayWidgetState extends State<HatsdisplayWidget> {
  late HatsdisplayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HatsdisplayModel());
  }
