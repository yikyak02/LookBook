...
import 'bottomsdisplay_model.dart';
export 'bottomsdisplay_model.dart';

class BottomsdisplayWidget extends StatefulWidget {
  const BottomsdisplayWidget({super.key});

  @override
  State<BottomsdisplayWidget> createState() => _BottomsdisplayWidgetState();
}

class _BottomsdisplayWidgetState extends State<BottomsdisplayWidget> {
  late BottomsdisplayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BottomsdisplayModel());
  }
