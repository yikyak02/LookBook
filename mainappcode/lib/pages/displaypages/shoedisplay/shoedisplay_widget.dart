...
import 'shoedisplay_model.dart';
export 'shoedisplay_model.dart';

class ShoedisplayWidget extends StatefulWidget {
  const ShoedisplayWidget({super.key});

  @override
  State<ShoedisplayWidget> createState() => _ShoedisplayWidgetState();
}

class _ShoedisplayWidgetState extends State<ShoedisplayWidget> {
  late ShoedisplayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShoedisplayModel());
  }
