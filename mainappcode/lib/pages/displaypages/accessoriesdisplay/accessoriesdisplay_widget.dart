...
import 'accessoriesdisplay_model.dart';
export 'accessoriesdisplay_model.dart';

class AccessoriesdisplayWidget extends StatefulWidget {
  const AccessoriesdisplayWidget({super.key});

  @override
  State<AccessoriesdisplayWidget> createState() =>
      _AccessoriesdisplayWidgetState();
}

class _AccessoriesdisplayWidgetState extends State<AccessoriesdisplayWidget> {
  late AccessoriesdisplayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccessoriesdisplayModel());
  }
