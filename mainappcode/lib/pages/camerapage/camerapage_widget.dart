...
import 'camerapage_model.dart';
export 'camerapage_model.dart';
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        TextFormField(
                                          controller: _model.ddTextController,
                                          focusNode: _model.ddFocusNode,
                                          autofocus: true,
                                          textCapitalization:
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          if ((_model.choiceChipsValue != null &&
                                  _model.choiceChipsValue != '') &&
                              (_model.uploadedFileUrl != '') &&
                              (_model.ddTextController.text != '') &&
                              (_model.brandTextController.text != '')) {
                            await WardrobeRecord.createDoc(
                                    currentUserReference!)
                                .set(createWardrobeRecordData(
                              ...
                              clothingname: _model.ddTextController.text,
                            ));
