...
class _WardrobeWidgetState extends State<WardrobeWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WardrobeModel());
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    context.pushNamed('outerdisplay');
                                  },
                                  child: Container(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('bottomsdisplay');
                                  },
                                  child: Container(
                                    width: double.infinity,
                                    decoration: BoxDecoration(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    context.pushNamed('accessoriesdisplay');
                                  },
                                  child: Container(
                                    width: double.infinity,
                                    decoration: BoxDecoration(
                                        ...
                                        children: [
                                          ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.network(
                                              'https://t4.ftcdn.net/jpg/00/96/01/73/360_F_96017330_p4FgpovvEbrNf8YGrm8rWfnLENpWX2aC.jpg',
                                              width: 70.0,
                                              height: 70.0,
                                              fit: BoxFit.cover,
                                            ),
                                        ...
                                        children: [
                                          ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.network(
                                              'https://img.freepik.com/premium-photo/male-baseball-cap-isolated-white-background_143092-4089.jpg',
                                              width: 70.0,
                                              height: 70.0,
                                              fit: BoxFit.cover,
                                            ),
